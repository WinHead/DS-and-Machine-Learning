...
class Trainer:
    ...
    def fit(self):
        ...
        # Совершаем заданное количество эпох
        for epoch in range(self.num_epochs):
            ...
            # Усредняем loss по всем мини батчам
            ave_loss = np.mean(batch_losses)

            # Считаем точность на всем трейне
            train_accuracy = self.compute_accuracy(self.dataset.train_X,
                                                   self.dataset.train_y)

            # Считаем точность на валидационных данных
        ...
        # Возвращаем итоговые loss и точности на трэйне и валидации
